...
export default function CarePage() {
  ...
  const speak = useCallback((msgId: string, text: string) => {
    ...
    utteranceRef.current = utterance; // Keep reference to prevent silent garbage collection failure (Chrome bug)

    // Try to explicitly assign a voice if available
  ...
  // Pre-load voices on mount to avoid cold-start silent failures
  useEffect(() => {
