...
export default function AuthPage() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (result.status === 'role-conflict') {
        setError(`This account is already used for another role. Use a different account or sign in as ${formatRole(result.storedRole)}.`);
        return;
      }
        ...
        <AnimatePresence mode="wait">
          ...
          {selectedRole && (
            ...
            >
              ...
              >
                <div className={`p-1.5 rounded-lg bg-gradient-to-br ${ROLES.find((role) => role.id === selectedRole)?.color} shadow`}>
                  {(() => {
